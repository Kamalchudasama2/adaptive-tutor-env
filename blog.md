...
**reward_curve.png — Adaptive Tutor Learns Better Teaching Strategy** *(50 episodes)*
...
**knowledge_plot.png — Student Knowledge Growth Under Trained Tutor** *(per session)*
